...
HRESULT CRenderer::Init(HWND hWnd, BOOL bWindow)
{
	...
	m_d3dpp.BackBufferWidth = SCREEN_WIDTH * IMGUI_WINDOW_CORRECT_X;	//ゲーム画面サイズ(幅)
	m_d3dpp.BackBufferHeight = SCREEN_HEIGHT * IMGUI_WINDOW_CORRECT_Y;	//ゲーム画面サイズ(高さ)
...
void CRenderer::Draw(void)
{
	...
	m_pD3DDevice->Clear(0, NULL,
		...
		D3DCOLOR_RGBA(200, 200, 200, 255), 1.0f, 0);
